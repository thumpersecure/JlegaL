...
1. Note the license number.
1. Open `https://li.phila.gov/property-history/...` for the property.
1. Find the same license number in the rendered table.
1. If the two disagree, the Eclipse value is authoritative.
...
1. **Pull live license status from L&I Eclipse.**
...
1. **Pull full violation history from Carto.**
